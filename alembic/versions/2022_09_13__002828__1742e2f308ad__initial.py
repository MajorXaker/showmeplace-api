...
def upgrade() -> None:
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_category_image_user_id_user'), ondelete='RESTRICT'),
    ...
    sa.Column('s3_filename', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_user_image_user_id_user'), ondelete='RESTRICT'),
    ...
    sa.Column('s3_filename', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['place_id'], ['place.id'], name=op.f('fk_place_image_place_id_place'), ondelete='RESTRICT'),
