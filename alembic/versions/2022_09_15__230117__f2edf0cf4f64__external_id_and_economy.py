...
Revision ID: f2edf0cf4f64
Revises: 52c193cebeb6
Create Date: 2022-09-15 23:01:17.071953
...
def upgrade() -> None:
    ...
    op.alter_column(
        "user", "cognito_user_id", new_column_name="external_id", nullable=False
    )
    op.add_column("user", sa.Column("external_id_type", sa.Text(), nullable=False))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column(
        "user", "external_id", new_column_name="cognito_user_id", nullable=False
    )
